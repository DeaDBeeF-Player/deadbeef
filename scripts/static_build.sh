...
if [[ "$ARCH" == "i686" ]]; then
    STATIC_DEPS="$STATIC_DEPS/lib-x86-32"
    export CFLAGS="-m32 -I$STATIC_DEPS/include"
    export LDFLAGS="-m32 -L$STATIC_DEPS/lib -L$STATIC_DEPS/lib/i386-linux-gnu"
    export CONFIGURE_FLAGS="--build=i686-unknown-linux-gnu"
    export LIBRARY_PATH="$STATIC_DEPS/lib"
    export PKG_CONFIG_PATH="$STATIC_DEPS/lib/pkgconfig"
    export GTK_ROOT_310="$STATIC_DEPS/gtk-3.10.8";
    export GTK_ROOT_216="$STATIC_DEPS/gtk-2.16.0";
    ...
    STATIC_DEPS="$STATIC_DEPS/lib-x86-64"
    export CFLAGS="-m64 -I$STATIC_DEPS/include"
    export LDFLAGS="-m64 -L$STATIC_DEPS/lib -L$STATIC_DEPS/lib/x86_64-linux-gnu"
...
#    export CONFIGURE_FLAGS="--build=x86_64-unknown-linux-gnu --disable-gtk2 --disable-gtk3 --disable-gme --disable-sid --disable-dumb --disable-psf --disable-nls --disable-adplug --disable-converter --disable-aac --disable-pltbrowser --disable-soundtouch --disable-mp3 --disable-oss --disable-alsa --disable-oss --disable-pipewire --disable-vtx --disable-sc68 --disable-musepack --disable-tta --disable-dca --disable-mms --disable-m3u --disable-shn --disable-mono2stereo --disable-wildmidi --disable-shellexec --disable-notify --disable-pulse --disable-supereq --disable-ffap"
    ...
    export GTK3_310_LIBS="-L${GTK_ROOT_310}/lib -L${GTK_ROOT_310}/lib/x86_64-linux-gnu -lgtk-3 -lgdk-3 -lpangocairo-1.0 -lpango-1.0 -latk-1.0 -lcairo-gobject -lcairo -lgdk_pixbuf-2.0 -lgio-2.0 -lgobject-2.0 -lgthread-2.0 -lglib-2.0"

# using clang requires higher version of libstdc++, than provided in staticdeps, so remove it
    rm $STATIC_DEPS/lib/libstdc*
elif [[ "$ARCH" == "aarch64" ]]; then
    STATIC_DEPS="$STATIC_DEPS/lib-aarch64"
    export CFLAGS="-I$STATIC_DEPS/include -fno-builtin"
    export LDFLAGS="-L$STATIC_DEPS/lib -L$STATIC_DEPS/lib/aarch64-linux-gnu"
    export CONFIGURE_FLAGS="--build=aarch64-unknown-linux-gnu"
# Keeping this here for debugging (faster builds)
#    export CONFIGURE_FLAGS="--build=aarch64-unknown-linux-gnu --disable-gtk2 --disable-gtk3 --disable-gme --disable-sid --disable-dumb --disable-psf --disable-nls --disable-adplug --disable-converter --disable-aac --disable-pltbrowser --disable-soundtouch --disable-mp3 --disable-oss --disable-alsa --disable-oss --disable-pipewire --disable-vtx --disable-sc68 --disable-musepack --disable-tta --disable-dca --disable-mms --disable-m3u --disable-shn --disable-mono2stereo --disable-wildmidi --disable-shellexec --disable-notify --disable-pulse --disable-supereq --disable-ffap"
    export LIBRARY_PATH="$STATIC_DEPS/lib"
    export PKG_CONFIG_PATH="$STATIC_DEPS/lib/pkgconfig"
    export GTK_ROOT_310="$STATIC_DEPS/gtk-3.10.8";
    export GTK_ROOT_216=$GTK_ROOT_310;

    export GDK_PIXBUF_LIBS="-L${GTK_ROOT_310}/lib -L${GTK_ROOT_310}/lib/aarch64-linux-gnu -lgdk_pixbuf-2.0 -lgobject-2.0 -lgthread-2.0 -lglib-2.0"

    export GTK3_310_CFLAGS="-I${GTK_ROOT_310}/include/at-spi-2.0 -I${GTK_ROOT_310}/include/at-spi2-atk/2.0 -I${GTK_ROOT_310}/include/atk-1.0 -I${GTK_ROOT_310}/include/cairo -I${GTK_ROOT_310}/include/dbus-1.0 -I${GTK_ROOT_310}/include/freetype2 -I${GTK_ROOT_310}/include/gdk-pixbuf-2.0 -I${GTK_ROOT_310}/include/gio-unix-2.0/ -I${GTK_ROOT_310}/include/glib-2.0 -I${GTK_ROOT_310}/include/gtk-3.0 -I${GTK_ROOT_310}/include/harfbuzz -I${GTK_ROOT_310}/include/libpng12 -I${GTK_ROOT_310}/include/mirclient -I${GTK_ROOT_310}/include/mircookie -I${GTK_ROOT_310}/include/mircore -I${GTK_ROOT_310}/include/pango-1.0 -I${GTK_ROOT_310}/include/pixman-1 -I${GTK_ROOT_310}/lib/aarch64-linux-gnu/glib-2.0/include -I${GTK_ROOT_310}/lib/dbus-1.0/include"
    ...
    export GTK2_216_CFLAGS="-I${GTK_ROOT_310}/include/at-spi-2.0 -I${GTK_ROOT_310}/include/at-spi2-atk/2.0 -I${GTK_ROOT_310}/include/atk-1.0 -I${GTK_ROOT_310}/include/cairo -I${GTK_ROOT_310}/include/dbus-1.0 -I${GTK_ROOT_310}/include/freetype2 -I${GTK_ROOT_310}/include/gdk-pixbuf-2.0 -I${GTK_ROOT_310}/include/gio-unix-2.0/ -I${GTK_ROOT_310}/include/glib-2.0 -I${GTK_ROOT_310}/include/gtk-2.0 -I${GTK_ROOT_310}/include/harfbuzz -I${GTK_ROOT_310}/include/libpng12 -I${GTK_ROOT_310}/include/mirclient -I${GTK_ROOT_310}/include/mircookie -I${GTK_ROOT_310}/include/mircore -I${GTK_ROOT_310}/include/pango-1.0 -I${GTK_ROOT_310}/include/pixman-1 -I${GTK_ROOT_310}/lib/aarch64-linux-gnu/glib-2.0/include -I${GTK_ROOT_310}/lib/aarch64-linux-gnu/gtk-2.0/include -I${GTK_ROOT_310}/lib/dbus-1.0/include"
...
find $STATIC_DEPS/lib/ -type f -name "*libcddb*so*" -o -name "*sndfile*so*" -o -name "*faad*so*" -o -name "*opencore*so*" -o -name "*libz*so*" -o -name "*libzip*so*" -o -name "*libav*so*" -o -name "*libopus*so*" -o -name "*dbus*so*" -o -name "*libexpat*so*" -o -name "*libmad*so*" -o -name "*libmpg123*so*" -o -name "*wavpack*so*" -o -name "*samplerate*so*" | xargs rm
