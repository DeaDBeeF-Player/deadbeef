...
#        ARCH=i686 ./scripts/portable_package_static.sh || exit 1
    ...
    osx)
        ...
        xcodebuild -project osx/deadbeef.xcodeproj -target DeaDBeeF -configuration Release || exit 1
        xcodebuild test -project osx/deadbeef.xcodeproj -scheme deadbeef -configuration Release || exit 1
