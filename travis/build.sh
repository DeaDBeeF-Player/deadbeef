case "$TRAVIS_OS_NAME" in
    linux)
        ...
        then
            ...
            sudo apt-get install -qq binutils-mingw-w64-x86-64 gcc-mingw-w64-x86-64
            ...
            ARCH=x86_64  PKG_CONFIG_PATH=/usr/x86_64-w64-mingw32/lib/pkgconfig ./scripts/configure_windows.sh --host=x86_64-w64-mingw32 --prefix="$PWD/deadbeef-win64-build"
