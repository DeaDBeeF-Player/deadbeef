...
gtkui_mainwin_init(void) {
    ...
    w_reg_widget (_("Selection metadata"), 0, w_selmetadata_create, "selmetadata", NULL);
    w_reg_widget (_("Track Properties"), DDB_WF_SUPPORTS_EXTENDED_API, w_properties_create, "trackproperties", NULL);
