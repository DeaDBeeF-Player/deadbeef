...
struct gtkScriptablePropertySheetEditWindowController_t {
    ...
    gtkScriptablePropertySheetEditViewController_t *content_view_controller;
    gtkScriptablePropertySheetEditViewControllerDelegate_t content_view_controller_delegate;

    gtkScriptablePropertySheetEditWindowControllerDelegate_t *delegate;
    void *context;
};
...
_content_scriptable_did_change (
                                gtkScriptablePropertySheetEditViewController_t *view_controller,
...
gtkScriptablePropertySheetEditWindowControllerNew (void) {
    ...
    gtkScriptablePropertySheetEditViewController_t *content_view_controller = gtkScriptablePropertySheetEditViewControllerNew ();
    ...
    GtkWidget *content_view = gtkScriptablePropertySheetEditViewControllerGetView (content_view_controller);
...
gtkScriptablePropertySheetEditWindowControllerSetScriptable(gtkScriptablePropertySheetEditWindowController_t *self, scriptableItem_t *scriptable) {
    ...
    if (scriptable != NULL) {
        resettable = 0 == (scriptableItemFlags (scriptable) & SCRIPTABLE_FLAG_IS_READONLY);
    }
    ...
    gtkScriptablePropertySheetEditViewControllerSetScriptable (self->content_view_controller, scriptable);
}
...
static void
_reset_did_activate (GtkButton *button, gpointer user_data) {
    gtkScriptablePropertySheetEditWindowController_t *self = user_data;
    scriptableItemReset (self->scriptable);
    gtkScriptablePropertySheetEditViewControllerSetScriptable (self->content_view_controller, self->scriptable);
...
_content_scriptable_did_change (
                                ...
                                gtkScriptableChange_t change_type,
                                void *context) {
    gtkScriptablePropertySheetEditWindowController_t *self = context;
    if (self->delegate != NULL && self->delegate->scriptable_did_change != NULL) {
