...
- (void)selectionDidChange {
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        [self.trackPropertiesListViewController loadFromPlaylist:playlist context:DDB_ACTION_CTX_SELECTION flags:TrackPropertiesListFlagMetadata|TrackPropertiesListFlagProperties|TrackPropertiesListFlagSectionHeaders|TrackPropertiesListFlagSmallFont];
