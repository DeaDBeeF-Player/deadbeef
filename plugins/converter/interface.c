...
create_converterdlg (void)
{
  ...
  gtk_widget_set_can_focus(path_label, TRUE);
  ...
  gtk_label_set_single_line_mode (GTK_LABEL (path_label), TRUE);
  gtk_label_set_angle (GTK_LABEL (path_label), 5);

  hseparator2 = gtk_hseparator_new ();
  gtk_widget_show (hseparator2);
  gtk_box_pack_start (GTK_BOX (vbox35), hseparator2, TRUE, TRUE, 0);

  vbox49 = gtk_vbox_new (FALSE, 6);
...
create_progressdlg (void)
{
  ...
  gtk_container_add (GTK_CONTAINER (frame17), table4);
