...
// these might or might not have appropriate fields in every tag type
    ...
    "MODIFIED_BY", "TPE4", "TPE4", "TP4", NULL, /* MIX_ARTIST */
    ...
    "ENCODING_SOFTWARE_HARDWARE", "TSSE", "TSSE", "TSS", NULL, /* Encoder settings */
    ...
    "BAND_SORT_ORDER", "TSO2", "TSO2", NULL, NULL, /* Album Artist */
    "COMPOSER_SORT_ORDER", "TSOC", "TSOC", NULL, NULL,
    ...
    "INVOLVED_PEOPLE_LIST", "IPLS", "TIPL", NULL, NULL,
    "MUSICIAN_CREDITS_LIST", NULL, "TMCL", NULL, NULL,
    "ENCODING_TIME", NULL, "TDEN", NULL, NULL,
    "ORIGINAL_RELEASE_DATE", "TORY", "TDOR", NULL, "ORIGINALYEAR",
    "MOOD", NULL, "TMOO", NULL, NULL,
    "PRODUCED_NOTICE", NULL, "TPRO", NULL, NULL,
    "musicbrainz_trackid", NULL, NULL, NULL, NULL,
    "COMPILATION", "TCMP", "TCMP", NULL, NULL, /* iTunes flag */
    "CONDUCTOR", "TPE3", "TPE3", NULL, NULL,
    "GROUPING", "GRP1", "GRP1", NULL, NULL,
    "MEDIA_TYPE", "TMED", "TMED", NULL, NULL,
    "MOVEMENT_INDEX", "MVIN", "MVIN", NULL, NULL,
    "MOVEMENT_NAME", "MVNM", "MVNM", NULL, NULL,
    "PODCAST", "PCST", "PCST", NULL, NULL, /* iTunes flag */
    "PODCAST_CATEGORY", "TCAT", "TCAT", NULL, NULL,
    "PODCAST_DESCRIPTION", "TDES", "TDES", NULL, NULL,
    "PODCAST_ID", "TGID", "TGID", NULL, NULL,
    "PODCAST_KEYWORDS", "TKWD", "TKWD", NULL, NULL,
    "PODCAST_URL", "TFED", "TFED", NULL, NULL,
    "PUBLISHER", "TPUB", "TPUB", NULL, NULL,
    "RATING_BY_APPS", "POPM", "POPM", NULL, NULL, /* POPULARIMETER, RATING MM, RATING WMP */
    "SET_SUBTITLE", "TSST", "TSST", NULL, NULL,
    "WWW", "WXXX", "WXXX", NULL, NULL,
    "WWW_ARTIST", "WOAR", "WOAR", NULL, NULL,
    "WWW_AUDIO_FILE", "WOAF", "WOAF", NULL, NULL,
    "WWW_AUDIO_SOURCE", "WOAS", "WOAS", NULL, NULL,
    "WWW_COMMERCIAL_INFO", "WCOM", "WCOM", NULL, NULL,
    "WWW_COPYRIGHT", "WCOP", "WCOP", NULL, NULL,
    "WWW_PAYMENT", "WPAY", "WPAY", NULL, NULL,
    "WWW_PUBLISHER", "WPUB", "WPUB", NULL, NULL,
    "WWW_RADIO_PAGE", "WORS", "WORS", NULL, NULL,
    NULL
};
...
junk_id3v2_set_metadata_from_frame (playItem_t *it, DB_id3v2_tag_t *id3v2_tag, DB_id3v2_frame_t *frame, const char *sb_charset) {
    ...
    if (version_major == 3 || version_major == 4) {
        ...
        if (!strcmp (frameid, "COMM")) {
            ...
            return junk_load_comm_frame (version_major, it, readptr, synched_size);
        }
